...
export default function Members() {
  ...
  const { data = [], loading, error } = useLoad(signal => activeServer ? call<Member[]>('ListServerMembers', { server_id: activeServer.id, limit: 200 }, signal) : Promise.resolve([]), [call, activeServer?.id])
