...
export default function Forums() {
  ...
  const { data: posts = [], loading, error, refresh } = useLoad(signal => activeServer ? call<Post[]>('SearchPosts', { server_id: activeServer.id, query, limit: 100 }, signal) : Promise.resolve([]), [call, activeServer?.id, query])
